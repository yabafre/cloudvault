        ...
        <CardContent className="p-4">
          ...
          <form onSubmit={handleSave} className="flex flex-col gap-3 relative z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              {saved && <span className="text-[10px] text-emerald-500 font-medium" role="status">Changes saved</span>}
            </div>
          </form>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-3 relative z-10">
            ...
            <div className="h-1.5 bg-[var(--secondary)] rounded-full overflow-hidden">
              <div className="h-full bg-emerald-500 rounded-full transition-all duration-500" style={{ width: `${(storageStats.totalSize / storageStats.maxSize) * 100}%` }} />
            </div>
            <div className="flex justify-between text-[10px]">
